import { Container } from "gql/generated/hooks"
import { Badge, Box, Group, SimpleGrid, Text } from "@mantine/core"
import ContentCard from "components/ContentCard"
import DetailColumn from "components/DetailColumn"
import QrGen from "components/QrGen"

interface IContainerDetailsHTMLProps {
    data: Container
}

export default function ContainerDetailsHTML(props: IContainerDetailsHTMLProps) {
    return (
        <SimpleGrid cols={2}>
            <SimpleGrid cols={1}>
                <ContentCard>
