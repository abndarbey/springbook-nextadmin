...
import { Sku, SkusResult } from "@lib/generated/hooks"
...
interface SkuTableProps {
    data: SkusResult
    viewAction: (item: Sku) => void
    editAction: (item: Sku) => void
    archiveAction: (item: Sku) => void
    unarchiveAction: (item: Sku) => void
    batchViewAction?: (selectedRecords: Sku[]) => void
