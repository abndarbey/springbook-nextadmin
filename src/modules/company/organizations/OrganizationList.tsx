...
export default function OrganizationList() {
    ...
    const viewAction = (item: Organization) => {
        router.push(`/company/organizations/${item.code}`)
    }
    const editAction = (item: Organization) => {
        router.push(`/company/organizations/${item.code}/edit`)
    }
    ...
    return (
        <Page navTrails={navTrails}>
            <PageHeader title='Organizations' buttons={actionButtons} />
            <OrganizationTable
