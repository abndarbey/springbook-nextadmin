...
export default function WarehouseEdit(props: IWarehouseEditProps) {
    const router = useRouter()
    const navTrails: INavTrailProps[] = [
        { title: 'Dashboard', href: '/' },
        { title: 'Warehouses', href: '/warehouses/warehouses' },
        { title: props.code, href: `/warehouses/warehouses/${props.code}` },
        { title: 'Edit', href: '#' },
    ]
    const form = useForm({
            initialValues: {
    ...
    const handleCancel = (e: any) => {
        e.preventDefault()
        router.push(`/warehouses/warehouses/${props.code}`)
    }
