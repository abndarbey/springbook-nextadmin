...
type SalesOrderTxnTableHTMLProps = {
...
type SalesOrderTxnTableProps = {
    uid: string | null | undefined
}

export default function SalesOrderTxnTable(props: SalesOrderTxnTableProps) {
...
const SalesOrderTxnTableHTML = (props: SalesOrderTxnTableHTMLProps) => {
