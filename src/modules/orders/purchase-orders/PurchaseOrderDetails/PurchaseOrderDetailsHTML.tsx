...
import PurchaseOrderStatusHTML from "./PurchaseOrderStatusHTML"

type  PurchaseOrderDetailsHTMLProps = {
    mb?: string | number
    data: PurchaseOrder
}

export default function PurchaseOrderDetailsHTML(props: PurchaseOrderDetailsHTMLProps) {
    return (
        <Grid>
            <Grid.Col span={8}>
            ...
            <Grid.Col span={4}>
                <PurchaseOrderStatusHTML mb="md" data={props.data?.details!} />
            </Grid.Col>
        </Grid>
    )
}
