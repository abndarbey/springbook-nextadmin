import { FilterOption, BatchCatalogue, BatchCataloguesResult, SortByOption, SortDir, useBatchCataloguesQuery } from "gql/generated/hooks"
...
export default function BatchCatalogueSelectModal(props: ISelectModalProps) {
    ...
    return (
        <Modal
            ...
            overlayBlur={3}
        >
            <PageHeader title='Select BatchCatalogue' />
            <BatchCatalogueTable
