import { FilterOption, Role, RolesResult, SortByOption, SortDir, useRolesQuery } from "@lib/generated/hooks"
...
export default function RoleSelectModal(props: ISelectModalProps) {
...
const RoleTable = (props: RoleTableProps) => {
    ...
    const [records, setRecords] = useState<Role[]>(props.data.roles.slice(0, pageSize))
    ...
    useEffect(() => {
        ...
        setRecords(props.data.roles.slice(from, to))
    }, [page, pageSize, props.data.roles])
