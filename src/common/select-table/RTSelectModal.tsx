import { FilterOption, RackType, RackTypesResult, SortByOption, SortDir, useRackTypesQuery } from "gql/generated/hooks"
...
export default function RackTypeSelectModal(props: ISelectModalProps) {
...
const RackTypeTable = (props: RackTypeTableProps) => {
    const theme = useMantineTheme()

    const [pageSize, setPageSize] = useState(PAGE_SIZES[1])
    const [page, setPage] = useState(1)
    const [records, setRecords] = useState<RackType[]>(props.data.rackTypes.slice(0, pageSize))
    const [selectedRecords, setSelectedRecords] = useState<RackType[]>([])
    ...
    useEffect(() => {
        ...
        setRecords(props.data.rackTypes.slice(from, to))
    }, [page, pageSize, props.data.rackTypes])
